...
#SBATCH --output=/home/m/m300950/superdrops_in_action/prescribed2dflow/conv1//temp//n4_runmany_out.%j.out
#SBATCH --error=/home/m/m300950/superdrops_in_action/prescribed2dflow/conv1//temp//n4_runmany_err.%j.out
