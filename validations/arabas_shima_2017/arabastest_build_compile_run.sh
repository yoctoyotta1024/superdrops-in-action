...
path2build=${HOME}/superdrops_in_action/validations/arabas_shima_2017/build/
configfile=${HOME}/superdrops_in_action/validations/arabas_shima_2017/arabasconfig.txt
python=python
gxx="g++"
gcc="gcc"

# path2CLEO=${HOME}/Documents/b1_springsummer2023/CLEO/
# #path2build=${HOME}/superdrops_in_action/validations/arabas_shima_2017/build/                 ### TODO: correct path for my home dir
# #configfile=${HOME}/superdrops_in_action/validations/arabas_shima_2017/arabasconfig.txt       ### TODO: correct path for my home dir
...
${python} arabastest.py ${path2CLEO} ${path2action} ${configfile}