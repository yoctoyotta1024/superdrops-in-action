...
path2data = "/work/mh1126/m300950/breakup/build/../constnfrags/"
binsubfolder = "./"
datalabel = "__nsupers2048_nfrags5p2_0"
...
class DatasetPaths:
  def __init__(self):
    ...
    self.setuptxt = path2dataset+"/setup"+datalabel[:-2]+".txt"
...
class ExperimentsPaths:
  def __init__(self):
    ...
    self.exps = ["n2", "n4", "n8", "n16", "n32", "n64", 
